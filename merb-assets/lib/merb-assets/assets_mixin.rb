...
module Merb
  ...
  #
  # **N.B.:** If you bundle an inconsistent set of assets with the same name,
  # you will have inconsistent results. Be thorough and test often.
  #
  ...
  #
  # @todo Implementation: very redundant, most things are just copy/paste
  #   with JS and CSS changed.
  module AssetsMixin
    ...
    #
    # The reason for separating {#auto_link} for CSS and JS is performance
    # concerns with page loading. So if you only need one, look at
    # {#auto_link_css} and {#auto_link_js}.
    #
    # @return [String] HTML
    #
    # @see #auto_link_css
    # @see #auto_link_js
    # @see http://developer.yahoo.com/performance/rules.html Yahoo! Performance Rules
    def auto_link
    ...
    #
    # @param [Symbol] asset_type A symbol representing the type of the asset.
    ...
    # Auxiliary method to get all possible asset paths for the current
    # controller/action.
    #
    ...
    # @param [#to_s] name The text of the link.
    # @param [#to_s] url The URL to link to.
    # @param [Hash<#to_s, #to_s>] opts Additional HTML options for the link.
    #
    # @example
    ...
    # @param [Hash] opts Additional options for the image tag. All values
    #   not mentioned below will be converted to HTML attributes.
    # @option opts [String] :path
    #   Sets the path prefix for the image. Defaults to `"/images/"` or
    #   whatever is specified in `Merb::Config`. This is ignored if `img`
    #   is an absolute path or full URL.
    # @option opts [Boolean] :reload
    #   Override the `Merb::Config[:reload_templates]` value. If true, a
    #   random query param will be appended to the image URL.
    # @option opts [Boolean, String] :timestamp
    #   Override the `Merb::Plugins.config[:asset_helpers][:asset_timestamp]`
    #   value. If true, a timestamp query param will be appended to the
    #   image URL. The value will be `File.mtime(Merb.dir_for(:public) / path)`.
    ...
    # @param [String] javascript Text to escape for use in JavaScript.
    #
    # @example
    ...
    #
    # @param [#to_s] *js JavaScript files to include.
    #
    # @example
    #   <% require_js 'jquery' %>
    ...
    #
    # @param [Hash] options Default options to pass to {#js_include_tag}.
    ...
    #
    # @param [#to_s] *css CSS files to include.
    #
    # @example
    #   <% require_css('style') %>
    ...
    #
    # @param [Hash] options<Hash>:: Default options to pass to {#css_include_tag}.
    ...
    # {#require_js}.
    #
    # @param [Hash] options Options to pass to {#js_include_tag}.
    # @option options [#to_s] :bundle
    ...
    # using {#require_css}.
    #
    # @param [Hash] options Options to pass to {#css_include_tag}.
    # @option options [#to_s] :bundle
    #   The name of the bundle the stylesheets should be combined into.
    # @option options [#to_s] :media (:all)
    #   The media attribute for the generated link element.
    #
    ...
    #
    # @overload js_include_tag(*scripts)
    #   @param [Array] *scripts The scripts to include. If `".js"` is left
    #     out from the script names, it will be added to them.
    #
    # @overload js_include_tag(*scripts, opts)
    #   @param [Array] *scripts The scripts to include. If `".js"` is left
    #     out from the script names, it will be added to them.
    #   @param [Hash] opts Additional options
    #   @option opts [#to_s] :charset
    #     Charset which will be used as value for charset attribute
    #   @option opts [#to_s] :bundle
    #     The name of the bundle the scripts should be combined into.
    #   @option opts [#to_s] :prefix
    #     Prefix to add to include tag, overrides any set in
    #     `Merb::Plugins.config[:asset_helpers][:js_prefix]`.
    #   @option opts [#to_s] :suffix
    #     suffix to add to include tag, overrides any set in
    #     `Merb::Plugins.config[:asset_helpers][:js_suffix]`.
    #   @option opts [Boolean] :reload
    #     Override the `Merb::Config[:reload_templates]` value. If true,
    #     a random query param will be appended to the JS URL.
    #   @option opts [Boolean, String] :timestamp
    #     Override the `Merb::Plugins.config[:asset_helpers][:asset_timestamp]`
    #     value. If true, a timestamp query param will be appended to the
    #     image URL. The value will be `File.mtime(Merb.dir_for(:public) / path)`.
    ...
    # @param [#to_s] *assets
    #   The assets to include. These should be the full paths to any static
    #   served file.
    #
    # @return [Array<String>, String] Full unique paths to assets OR a
    #   plain string if only a single path is requested.
    #
    # @example
    ...
    # @param [#to_s] *assets
    #   Creates unique paths for javascript files (prepends `"/javascripts"`
    #   and appends `".js"`)
    #
    # @return (see #uniq_path)
    #
    # @example
    #   uniq_js_path("my")
    ...
    # @param [#to_s] *assets
    #   Creates unique paths for stylesheet files (prepends
    #   `"/stylesheets"` and appends `".css"`)
    #
    # @return (see #uniq_path)
    #
    # @example
    ...
    #
    # @param [Hash] options Options to pass to include tag methods.
