...
module Merb::Slices::RouterExtensions
  ...
  #
  # By combining this with {Merb::Slices.activate_by_file} and
  # {Merb::Slices.deactivate} one can enable/disable slices at runtime,
  # without restarting your app.
  #
  # @param [Hash] config Optional hash, mapping slice module names to
  ...
  #
  # @param [String, Symbol, Module] slice_module A Slice module to mount.
  ...
  #   executed.
  #
  # @note Normally you should specify the slice_module using a String or
  #   Symbol to ensure that your module can be removed from the router at
  #   runtime.
  ...
  #
  # This will still setup a namespace, but doesn't set a path prefix. Only
  # for special cases.
