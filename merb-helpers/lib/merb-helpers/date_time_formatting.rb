module DateAndTimeFormatting
  ...
  module InstanceMethods
    ...
    #
    # @param [Symbol] format The format key from {DateAndTimeFormatting::ClassMethods date formats}
    #
    ...
    #
    # You can also add your own formats using {DateAndTimeFormatting::ClassMethods#add_format add_format} when your
    # app loads by adding something like  the following to your `init.rb`:
  ...
  module ClassMethods
    ...
    #
    # @return [Hash] A hash with all formats available.
    #
    # @api public
    def formats
      @@formats
    ...
    #
    # @param [Symbol] key Name of the format.
    # @param [Hash] format Time format to use
    #
    # @return [Hash] a hash with all formats available
    #
    # @example
